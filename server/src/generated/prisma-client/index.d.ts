...
export interface LessonWhereInput {
  ...
  objective?: Maybe<String>;
  objective_not?: Maybe<String>;
  objective_in?: Maybe<String[] | String>;
  objective_not_in?: Maybe<String[] | String>;
  objective_lt?: Maybe<String>;
  objective_lte?: Maybe<String>;
  objective_gt?: Maybe<String>;
  objective_gte?: Maybe<String>;
  objective_contains?: Maybe<String>;
  objective_not_contains?: Maybe<String>;
  objective_starts_with?: Maybe<String>;
  objective_not_starts_with?: Maybe<String>;
  objective_ends_with?: Maybe<String>;
  objective_not_ends_with?: Maybe<String>;
  details?: Maybe<String>;
...
export interface LessonPreviousValuesSubscription
  ...
  objective: () => Promise<AsyncIterator<String>>;
  details: () => Promise<AsyncIterator<String>>;
}
